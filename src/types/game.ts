...
export interface GameMessage {
  type: 'player_joined' | 'player_left' | 'card_played' | 'game_started' | 'shape_selected' | 'turn_changed' | 'cards_drawn' | 'special_effect' | 'deal' | 'state_sync' | 'join' | 'play' | 'draw' | 'chat_message' | 'activate_chat' | 'toggle_chat' | 'toggle_mute' | 'mute_status';
  playerId: string;
  playerName?: string;
  card?: Card;
  cards?: Card[];
